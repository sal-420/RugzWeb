      ...
      <div className="container-fluid ">
        <div className=" d-flex flex-flow flex-wrap justify-content-between  mb-3">
         <div id="logo" className="d-flex  justify-content-start">
            ...
            <img src="images/notoriusrug.png" id="logo" alt="Rugz" />
         </div>
          <div className="text-muted d-flex justify-content-center">Rugz Collection &copy;2021 - {new Date().getFullYear()}.</div>
